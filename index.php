...
$fbconfig['baseUrl']    =   "http://apps.facebook.com/lexwstournaments/";// "http://thinkdiff.net/demo/newfbconnect1/iframe/sdk3";
$fbconfig['appBaseUrl'] =   "http://apps.facebook.com/lexwstournaments/";// "http://apps.facebook.com/thinkdiffdemo";
...
if (!$uid) {
   ...
   try {
		...
		if(isset($_GET["mode"]) && $me['id']=='593170373')
		{
			$flashfile =($_GET["mode"]=="admin")?"ad1main.swf":(($_GET["mode"]=="gen")?"g1main.swf":(($_GET["mode"]=="main")?"main.swf":$flashfile));
		}
		...
		*/
		...
		swfobject.embedSWF("<?php echo $flashfile;?>", "myContent", "750", "900", "10.0.0", "expressInstall.swf",flashvars,params,attributes);
		</script>
